...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=4 python run.py reinvent_selfies --task simple --oracle $oralce --wandb online --run_name rnd --seed $seed --config_default hparams_symrd_rnd.yaml
done
done
