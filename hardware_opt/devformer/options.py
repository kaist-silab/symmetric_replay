...
def get_options(args=None):
    ...
    parser.add_argument('--greedy_distil', action='store_true')
    parser.add_argument('--distil_mask', default='bl')
    parser.add_argument('--clip_distil_ll', action='store_true')
    ###########################################################################
    ...
    opts.run_name = "{}_{}_{}_{}".format(opts.run_name, opts.method, opts.seed, time.strftime("%Y%m%dT%H%M%S"))
