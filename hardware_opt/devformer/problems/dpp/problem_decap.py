...
import numpy as np
from problems.dpp.state_decap import StateDecap
from problems.dpp.reward_function_serial import reward_gen
...
class DecapDataset(Dataset):
    def __init__(
        self, filename=None, size=50, num_samples=1000000, offset=0, distribution=None,decap_x = 10, decap_y = 10
    ):
